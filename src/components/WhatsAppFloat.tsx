...
/** Floating WhatsApp action — ES pages only, hidden until the number is configured. */
export default async function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white transition-transform duration-300 hover:scale-110"
    >
